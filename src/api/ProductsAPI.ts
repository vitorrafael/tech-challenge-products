...
const productsAPIRouter: Router = Router();

productsAPIRouter.get("/products", async (_req: Request, res: Response) => {
  try {
...
productsAPIRouter.get("/products/:id", async (req: Request, res: Response) => {
  try {
...
productsAPIRouter.delete("/products/:id", async (req: Request, res: Response) => {
  try {
    const id = Number(req.params.id);
